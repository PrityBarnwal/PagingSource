package com.applaunch.paginationdemo.bottomIndicator
...
import com.applaunch.paginationdemo.R.styleable.*
...
class BottomNavigationViewIndicator @JvmOverloads constructor(
        ...
        if (attrs == null) {
            ...
            with(context.obtainStyledAttributes(attrs, BottomNavigationViewIndicator)) {
                ...
                backgroundDrawable = if (clipableId != NO_ID) {
                    AppCompatResources.getDrawable(context, clipableId) ?: ColorDrawable(Color.TRANSPARENT)
                } else {
    ...
    override fun onAttachedToWindow() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) elevation = child.elevation
